...
```
testmu-jmeter-studio-1.3.10-share.zip          ←  the one you want
  └── testmu-jmeter-studio/
        manifest.json
        background.js
        popup.html …

testmu-jmeter-studio-1.3.10.zip                ←  only for a Chrome Web Store submission
  ├── manifest.json
  ├── background.js
  ├── popup.html …
```
...
`testmu-jmeter-studio-1.3.10-share.zip`, then **Download raw file** at the top right.
