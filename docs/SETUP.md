...
```
testmu-jmeter-studio-1.6.1-share.zip          ←  the one you want
  └── testmu-jmeter-studio/
        manifest.json
        background.js
        popup.html …

testmu-jmeter-studio-1.6.1.zip                ←  only for a Chrome Web Store submission
  ├── manifest.json
  ├── background.js
  ├── popup.html …
```
...
`testmu-jmeter-studio-1.6.1-share.zip`, then **Download raw file** at the top right.
