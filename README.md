...
```
1. unzip dist/testmu-jmeter-studio-1.6.4-share.zip
...
```
dist/testmu-jmeter-studio-1.6.4-share.zip     6.0 MB   →  people (Load unpacked)
dist/testmu-jmeter-studio-1.6.4.zip           6.0 MB   →  Chrome Web Store, unlisted
```
