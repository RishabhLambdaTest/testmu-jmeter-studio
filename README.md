...
```
1. unzip dist/testmu-jmeter-studio-1.3.11-share.zip
...
```
dist/testmu-jmeter-studio-1.3.11-share.zip     6.3 MB   →  people (Load unpacked)
dist/testmu-jmeter-studio-1.3.11.zip           6.3 MB   →  Chrome Web Store, unlisted
```
